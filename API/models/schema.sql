...
CREATE TABLE IF NOT EXISTS `rafr`.`feature` (
  ...
  `productArea` INT UNSIGNED NOT NULL,
...
GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE `rafr`.* TO 'rafrappuser';
...
START TRANSACTION;
USE `rafr`;
INSERT INTO `rafr`.`productArea` (`id`, `name`) VALUES (1, 'Product');
INSERT INTO `rafr`.`productArea` (`id`, `name`) VALUES (2, 'Billing');
INSERT INTO `rafr`.`productArea` (`id`, `name`) VALUES (3, 'Claims');
INSERT INTO `rafr`.`productArea` (`id`, `name`) VALUES (4, 'Reports');
...
START TRANSACTION;
USE `rafr`;
INSERT INTO `rafr`.`client` (`id`, `name`) VALUES (1, 'Client A');
INSERT INTO `rafr`.`client` (`id`, `name`) VALUES (2, 'Client B');
INSERT INTO `rafr`.`client` (`id`, `name`) VALUES (3, 'Client C');
...
START TRANSACTION;
USE `rafr`;
INSERT INTO `rafr`.`feature` (`id`, `title`, `description`, `clientPriority`, `targetDate`, `ticketUrl`, `client`, `productArea`, `status`, `createdBy`) VALUES (1, 'Test Feature 1', 'This is a test feature', 1, NULL, 'http://not.a.fake.address/seriously-this-is-real', 1, 1, 1, 1);
INSERT INTO `rafr`.`feature` (`id`, `title`, `description`, `clientPriority`, `targetDate`, `ticketUrl`, `client`, `productArea`, `status`, `createdBy`) VALUES (2, 'Test Feature 2', 'This is a test feature', 1, NULL, 'http://not.a.fake.address/seriously-this-is-real', 2, 2, 2, 2);
...
START TRANSACTION;
USE `rafr`;
INSERT INTO `rafr`.`thread` (`id`, `name`, `feature`) VALUES (1, 'T1 For F1', 1);
INSERT INTO `rafr`.`thread` (`id`, `name`, `feature`) VALUES (2, 'T2 For F1', 1);
INSERT INTO `rafr`.`thread` (`id`, `name`, `feature`) VALUES (3, 'T1 For F2', 2);
INSERT INTO `rafr`.`thread` (`id`, `name`, `feature`) VALUES (4, 'T2 For F2', 2);
...
INSERT INTO `rafr`.`post` (`id`, `content`, `thread`, `user`) VALUES (2, 'Test content', 1, 2);
INSERT INTO `rafr`.`post` (`id`, `content`, `thread`, `user`) VALUES (3, 'Test content', 2, 1);
INSERT INTO `rafr`.`post` (`id`, `content`, `thread`, `user`) VALUES (4, 'Test content', 2, 2);
...
INSERT INTO `rafr`.`subscription` (`id`, `type`, `thread`, `user`) VALUES (3, 1, 2, 2);
INSERT INTO `rafr`.`subscription` (`id`, `type`, `thread`, `user`) VALUES (4, 2, 2, 2);

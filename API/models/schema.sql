...
INSERT INTO `rafr`.`feature` (`id`, `title`, `description`, `clientPriority`, `targetDate`, `ticketUrl`, `client`, `productArea`, `status`, `createdBy`) VALUES (2, 'Test Feature 2', 'This is a test feature', 1, NULL, 'http://not.a.fake.address/seriously-this-is-real', 2, 2, 2, 1);
INSERT INTO `rafr`.`feature` (`id`, `title`, `description`, `clientPriority`, `targetDate`, `ticketUrl`, `client`, `productArea`, `status`, `createdBy`) VALUES (3, 'Test Feature 3', 'This is a test feature', 2, NULL, 'http://not.a.fake.address/seriously-this-is-real', 2, 3, 1, 1);
